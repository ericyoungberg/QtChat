...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChatInput_t, stringdata) + ofs \
...
void ChatInput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->enterKeyPressed(); break;
        default: ;
        }
        ...
        {
            typedef void (ChatInput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatInput::enterKeyPressed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ChatInput::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_ChatInput.data,
...
// SIGNAL 0
void ChatInput::enterKeyPressed()
{

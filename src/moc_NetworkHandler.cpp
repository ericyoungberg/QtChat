...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NetworkHandler_t, stringdata) + ofs \
...
void NetworkHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NetworkHandler::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkHandler::queueRouter)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void NetworkHandler::queueRouter(QString _t1, QString _t2)
{
